...
| [`batch-freellm-auto-2026-09-25`](./batch-freellm-auto-2026-09-25/) | 2026-09-25 | Modo batch JSON sin ToolUse nativo, `llm_model: "auto"`, proxy local, rotación de modelos | Compatibilidad validada (5 llamadas, 9/9 tests, sin `BATCH_JSON_INVALID`); ahorro de tokens frente a ToolUse nativo queda por medir |