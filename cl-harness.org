...
proveedores de LLM (OpenRouter, Anthropic, OpenAI, Gemini, Groq, Ollama) para
decidir, /por turno/, qué hechos técnicos se envían al modelo y cuáles se
descartan — y para conservar, entre sesiones, un *segundo motor de memoria a
largo plazo*.
